...
@section('title', 'Rekapitulasi Alumni - Admin')
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group">
                                <a href="{{ route('admin.rekapitulasi.detail', $item->graduation_year) }}" 
                                   class="btn btn-sm btn-info" title="Lihat Detail">
                                    <i class="fas fa-eye"></i> Detail
                                </a>
                                <a href="{{ route('admin.rekapitulasi.print', $item->graduation_year) }}" 
