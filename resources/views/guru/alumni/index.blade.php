...
@section('title', 'Data Alumni - Guru')
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('guru.alumni.index') }}">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <a href="{{ route('guru.alumni.index') }}" class="btn btn-secondary">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('guru.alumni.show', $item->id) }}" class="btn btn-sm btn-info" title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('guru.alumni.print', $item->id) }}" class="btn btn-sm btn-secondary" title="Print" target="_blank">
