...
@section('title', $jobVacancy->title . ' - Lowongan Pekerjaan')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><i class="fas fa-briefcase"></i> Detail Lowongan Pekerjaan</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('job_vacancies.index') }}" class="btn btn-sm btn-secondary">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    @if($jobVacancy->deadline && $jobVacancy->deadline->isPast())
                        <span class="badge badge-danger badge-lg">Berakhir</span>
                    @elseif($jobVacancy->deadline && $jobVacancy->deadline->diffInDays() <= 7)
                        <span class="badge badge-warning badge-lg">Segera Berakhir</span>
                    @else
                ...
                <!-- Apply Button -->
                @if($jobVacancy->application_url && (!$jobVacancy->deadline || !$jobVacancy->deadline->isPast()))
                <div class="text-center mt-4">
                    <a href="{{ $jobVacancy->application_url }}" target="_blank" class="btn btn-success btn-lg">
                        <i class="fas fa-external-link-alt"></i> Lamar Pekerjaan Ini
                    </a>
                </div>
                @endif
            </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body text-center">
                ...
                <small class="text-muted">
                    <i class="fas fa-calendar"></i> {{ $jobVacancy->created_at->format('d F Y') }}
                </small>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <h6 class="mb-1">
                        <a href="{{ route('job_vacancies.show', $recent->id) }}" class="text-decoration-none">
